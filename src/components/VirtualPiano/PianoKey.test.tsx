...
describe('PianoKey', () => {
  ...
  it('renders white key correctly', () => {
    render(<PianoKey note="C4" type="white" onStartNote={onStartNote} onStopNote={onStopNote} />)
  ...
  it('renders black key correctly', () => {
    render(<PianoKey note="C#4" type="black" onStartNote={onStartNote} onStopNote={onStopNote} />)
