...
export const ProfilePage: React.FC = () => {
  ...
  return (
    <AppLayout>
      ...
      <div className="flex-1 py-4 md:p-6 md:px-6 space-y-6 overflow-y-auto">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-bold text-slate-800 dark:text-white">Thành Tích Của Bạn</h2>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                Xóa toàn bộ tiến trình và bắt đầu lại từ đầu. Điều này sẽ xóa XP, các bài đã học, và
